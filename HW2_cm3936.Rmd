...
mrtrashwheel = read_xlsx("./trash_wheel_collection_data.xlsx", 
                        ...
                        .name_repair = "unique",
                            ...
                            mutate(mrtrashwheel, wheel = 'mrtrashwheel' )


mutate(mrtrashwheel, sports_balls_round = as.integer(round(sports_balls))
       
professortrash = read_xlsx("./trash_wheel_collection_data.xlsx", 
                        ...
                        .name_repair = "unique") |>
                         janitor::clean_names() |>
                          mutate(professortrash, wheel = 'professortrash')

gwynndatrash = read_xlsx("./trash_wheel_collection_data.xlsx", 
                        ...
                        .name_repair = "unique") |>
                         janitor::clean_names() |>
                        mutate(gwynndatrash, wheel = 'gwynndatrash')
